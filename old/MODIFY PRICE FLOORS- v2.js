document.addEventListener('DOMContentLoaded', () => {
    ...
    const modifyPriceShowCase = (products) => {
        products.forEach((product, index) => {
            ...
            if(!!item && !product.classList.contains("modified")){
                ...
                discountPrice.innerText = `R$ ${tranformInString(getdiscountPrice(priceMeter, discountPercentage))} m²`;
                totalPrice.innerText = `R$ ${tranformInString(priceMeter)} m²`;
            }
        });
    }
    ...
    const modifyPricePageProduct = (product, item) => {
        ...
        product.querySelector(".avista").innerText = "/Caixa no pix";
        ...
        document.querySelectorAll(".modal-floor .box-meter").forEach((spanBoxMeter) => spanBoxMeter.innerText = `${item.boxMeter}m²`);
        ...
        product.querySelector(".preco-economiza").innerText = `R$ ${tranformInString(getdiscountPrice(priceMeter, discountPercentage))} m² no pix`;
        ...
        const updateTotalPrice = (currentQuantity) => {
            ...
            btnBuyModal.setAttribute("href", `https://www.guemat.com.br/carrinho/produto/${productID}/adicionar/${currentQuantity}`);
        }
